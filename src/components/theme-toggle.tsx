...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <>
        <div className="h-9 w-9 rounded-full border-2 border-stone-300 bg-white/40 shadow-inner sm:hidden" />
  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-9 w-9 items-center justify-center rounded-full border-2 border-stone-300 bg-white/40 shadow-inner transition-all hover:border-stone-400 dark:border-stone-700 dark:bg-stone-900/40 sm:hidden"
      ...
      >
        {isDark ? (
          ...
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="h-4 w-4 text-stone-950" aria-hidden="true">
